...
const DirectionsMapPharmacy: React.FC<DirectionsMapProps> = ({
  start,
  end,
}) => {
  const map = useMap();
  ...
  const { setDistancePharmacy } = useSelectedPharmacyPoiStore();
...
export default DirectionsMapPharmacy;
