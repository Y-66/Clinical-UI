...
import { Card, Button, Radio, Space, Divider, Tag } from "antd";
import {
  CheckCircleOutlined,
  ClockCircleOutlined,
  EnvironmentOutlined,
...
const Sending: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 h-full">
      {/* Requisition Card */}
      <Card className="shadow-xl rounded-2xl border-2 border-orange-100">
        {/* Header */}
        ...
        {/* Requested Tests */}
        <div className="mb-8 p-5 bg-orange-50 rounded-xl border-2 border-orange-200">
          <div className="flex items-start gap-3 mb-4">
            <ExperimentOutlined className="text-orange-600 text-2xl mt-1" />
            <div>
              <h3 className="text-lg font-bold text-gray-800 m-0 mb-1">
                Requested Tests
              </h3>
              <p className="text-sm text-gray-600 m-0">4 tests scheduled</p>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            <Tag color="orange" className="text-sm py-1">
        ...
        <div className="p-6 bg-gray-50 rounded-xl space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-mono text-xs bg-white px-3 py-1 rounded font-semibold text-gray-800">
              REQ-2025-001234
            </span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-semibold text-gray-800">4 items</span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold text-orange-600">Tomorrow, 9:00 AM</span>
          </div>
        </div>
      </Card>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-base font-bold text-gray-800 m-0 mb-1">
                          Pickup at Pharmacy
                        </h4>
                        <p className="text-sm text-gray-600 m-0 mb-2">
                          Visit the pharmacy to collect
                        </p>
