...
const AutoPrescriptionWorkflow: React.FC = () => {
  ...
  const { prescriptionId, hasGeneratedPrescription, setPrescriptionId } = usePrescriptionWorkflowStore();
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Clinical staff review and refine before approval.",
      icon: <SearchOutlined />,
    },
    {
      title: "Fax Confirmation",
      description: "Finalize and send prescription",
      icon: <SendOutlined />,
    },
  ];
    ...
    <div className="min-h-screen w-full p-8 relative bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto mb-12 text-center relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-3 tracking-tight">
          Auto Prescription Workflow
        </h1>
        <p className="text-slate-500 text-lg max-w-2xl mx-auto font-medium">
          Generate, review and fax a prescription form automatically
        </p>
      </div>
              ...
              <TransitionGroup component={null}>
                <CSSTransition key={current} timeout={500} classNames="page">
                  <div className="w-full">
                    ...
                    {current === 1 && <PrescriptionGeneration patientId={patientId} />}
